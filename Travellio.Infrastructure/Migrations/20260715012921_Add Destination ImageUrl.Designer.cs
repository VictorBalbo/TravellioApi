...
namespace Travellio.Infrastructure.Migrations
{
    ...
    [Migration("20260715012921_Add Destination ImageUrl")]
    partial class AddDestinationImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Accommodation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Airport", b =>
                {
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Destination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Leg", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Transportation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Trip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("HomePlaceName")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)")
                        .HasColumnName("home_place_name");
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Accommodation", b =>
                {
                    b.HasOne("Travellio.Domain.Entities.Destination", null)
                    ...
                    b.OwnsOne("Travellio.Domain.Entities.Coordinates", "Coordinates", b1 =>
                        {
                    ...
                    b.OwnsOne("Travellio.Domain.Entities.Price", "Price", b1 =>
                        {
                            b1.Property<Guid>("AccommodationId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Destination", b =>
                {
                    b.HasOne("Travellio.Domain.Entities.Trip", null)
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Leg", b =>
                {
                    b.HasOne("Travellio.Domain.Entities.Transportation", null)
                        .WithMany("Legs")
                    ...
                    b.OwnsOne("Travellio.Domain.Entities.Coordinates", "ArrivalPlaceCoordinates", b1 =>
                        {
                    ...
                    b.OwnsOne("Travellio.Domain.Entities.Coordinates", "DeparturePlaceCoordinates", b1 =>
                        {
                            b1.Property<Guid>("LegId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Travellio.Domain.Entities.Transportation", b =>
                {
                    b.HasOne("Travellio.Domain.Entities.Destination", "Arrival")
                        .WithMany()
                        .HasForeignKey("ArrivalDestinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_transportations_destinations_arrival_destination_id");

                    b.HasOne("Travellio.Domain.Entities.Destination", "Departure")
                        .WithMany()
