...
namespace Travellio.Api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    coordinates_lat = table.Column<decimal>(type: "numeric(8,6)", precision: 8, scale: 6, nullable: false),
                    coordinates_lng = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    departure_place_short_name = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    departure_place_description = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    departure_place_coordinates_lat = table.Column<decimal>(type: "numeric(8,6)", precision: 8, scale: 6, nullable: false),
                    departure_place_coordinates_lng = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
                    arrival_place_id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    arrival_place_short_name = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    arrival_place_description = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    arrival_place_coordinates_lat = table.Column<decimal>(type: "numeric(8,6)", precision: 8, scale: 6, nullable: false),
                    arrival_place_coordinates_lng = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
